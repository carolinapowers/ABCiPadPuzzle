...
.directive('ngDrop', ['$parse', '$timeout', '$window', '$document', 'ngDraggable', function ($parse, $timeout, $window, $document, ngDraggable) {
        return {
            ...
            link: function (scope, element, attrs) {
                ...
                var updateDragStyles = function (touching, dragElement, evt) {
                    //console.log(evt);
                    if (touching) {
                        element.addClass('drag-enter');
                        // element.style.margin = "30 px";
                        ...
                        //                        evt.preventDefault();
                        //
                        //                        var htmlElement = document.getElementById(evt.dataTransfer.getData('Text'));
                        //                        this.appendChild(htmlElement)
                        //element.target.appendChild(document.getElementById(_data));
